...
import com.labo.prueba.mapper.ArticulosMapper;
...
public class ArticuloService {
    ...
    private final ArticulosMapper articulosMapper;
    ...
    public void save(ArticuloDTO articuloDTO){
        ...
        articuloRepository.save(articulosMapper.dtoToArt(articuloDTO));
    }

    public List<ArticuloDTO> getAll() {
        List<Articulo> articulos = articuloRepository.findAll();
        return articulosMapper.getArtDtos(articulos);
    }
}
